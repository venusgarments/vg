      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-3">
            ...
            <h3 className="text-[#111111] font-bold text-lg mb-3">VENUS GARMENTS</h3>
      ...
      <path d="M21.8 8.001a2.74 2.74 0 0 0-1.93-1.94C17.91 5.5 12 5.5 12 5.5s-5.91 0-7.87.56A2.74 2.74 0 0 0 2.2 8.001 28.63 28.63 0 0 0 1.5 12a28.63 28.63 0 0 0 .7 3.999 2.74 2.74 0 0 0 1.93 1.94C6.09 18.5 12 18.5 12 18.5s5.91 0 7.87-.56a2.74 2.74 0 0 0 1.93-1.94A28.63 28.63 0 0 0 22.5 12a28.63 28.63 0 0 0-.7-3.999z" />
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li><Link to="/products" className="py-1 px-2 -mx-2 rounded hover:bg-[#CBE600] transition-colors inline-block">Products</Link></li>
              <li><Link to="/overview" className="py-1 px-2 -mx-2 rounded hover:bg-[#CBE600] transition-colors inline-block">Overview</Link></li>
              <li><Link to="/pricing" className="py-1 px-2 -mx-2 rounded hover:bg-[#CBE600] transition-colors inline-block">Pricing</Link></li>
              <li><Link to="/releases" className="py-1 px-2 -mx-2 rounded hover:bg-[#CBE600] transition-colors inline-block">Releases</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              {/* Matches Change 5 */}
              <li><Link to="/about" className="py-1 px-2 -mx-2 rounded hover:bg-[#CBE600] transition-colors inline-block">About Us</Link></li>
              <li><Link to="/contact" className="py-1 px-2 -mx-2 rounded hover:bg-[#CBE600] transition-colors inline-block">Contact</Link></li>
              <li><Link to="/news" className="py-1 px-2 -mx-2 rounded hover:bg-[#CBE600] transition-colors inline-block">News</Link></li>
              <li><Link to="/support" className="py-1 px-2 -mx-2 rounded hover:bg-[#CBE600] transition-colors inline-block">Support</Link></li>
            </ul>
          </div>

          {/* Subscribe */}
          <div className="md:col-span-3">
            <h4 className="text-[#111111] font-semibold mb-3">STAY UP TO DATE</h4>
            <p className="text-sm text-gray-700 mb-4">Enter your email for exclusive offers and new arrivals.</p>
        ...
        <div className="border-t border-[#CBE600] mt-8 pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-gray-700">© {new Date().getFullYear()} Venus Garments. All rights reserved.</p>
