...
export const RETURNED_ORDER_REQUEST = "RETURNED_ORDER_REQUEST";
export const RETURNED_ORDER_SUCCESS = "RETURNED_ORDER_SUCCESS";
export const RETURNED_ORDER_FAILURE = "RETURNED_ORDER_FAILURE";
...
export const DASHBOARD_OVERVIEW_FAILURE = "DASHBOARD_OVERVIEW_FAILURE";
